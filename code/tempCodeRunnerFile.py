...
class Game:  
    ...
    def setup(self):  
        ...
        tmx_map = load_pygame(r'D:\Programming\Platform 4 finish\data\maps\world2.tmx')  # Updated path  
    ...
    def run(self):  
        ...
        while self.running:  
            ...
            if not self.paused:  
                ...
                if elapsed_time >= self.game_duration:  # Game duration is specified  
                    self.running = False  
    ...
    def run_game(self):  
        ...
        self.setup()  # Setup the game again  
